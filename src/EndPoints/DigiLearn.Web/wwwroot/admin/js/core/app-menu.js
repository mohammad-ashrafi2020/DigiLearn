	...
	$.app.menu = {
		...
		change: function (defMenu, menuIconColorsObj) {
			...
			if (currentBreakpoint.name == 'xl') {
				$('body[data-open="hover"] .main-menu-content .dropdown').on('mouseenter', function () {
				...
				$('body[data-open="hover"] .main-menu-content .dropdown a').on('click', function (e) {
					if (menuType == 'horizontal-menu') {
						var $this = $(this);
			...
			if (menuType == 'horizontal-menu') {
				$('li.dropdown-submenu').on('mouseenter', function () {
					...
					if (dd) {
						...
						if (((pageHeight - ddTop) - ddHeight - 28) < 1) {
							...
							if( $('li.dropdown-submenu.show .dropdown-menu').length ){
				...
				if( $('body').data('open') == 'click' ){
					$('li.dropdown-submenu [data-toggle=dropdown]').on('click', function () {
						if( $('li.dropdown-submenu.show .dropdown-menu').length && !$('li.dropdown-submenu.show .dropdown-menu').hasClass('ps') ){
							var menu_content = new PerfectScrollbar('li.dropdown-submenu.show .dropdown-menu', {
								wheelPropagation: false
							});
						}
